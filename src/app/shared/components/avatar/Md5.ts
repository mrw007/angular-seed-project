...
export abstract class Md5 {
  ...
  private static FF(
    ...
    a = Md5.AddUnsigned(
      a,
      Md5.AddUnsigned(Md5.AddUnsigned(Md5.F(b, c, d), x), ac)
    );
  ...
  private static GG(
    ...
    a = Md5.AddUnsigned(
      a,
      Md5.AddUnsigned(Md5.AddUnsigned(Md5.G(b, c, d), x), ac)
    );
    return Md5.AddUnsigned(Md5.RotateLeft(a, s), b);
  }
  ...
  private static HH(
    ...
    a = Md5.AddUnsigned(
      a,
      Md5.AddUnsigned(Md5.AddUnsigned(Md5.H(b, c, d), x), ac)
    );
    return Md5.AddUnsigned(Md5.RotateLeft(a, s), b);
  }
  ...
  private static II(
    ...
    a = Md5.AddUnsigned(
      a,
      Md5.AddUnsigned(Md5.AddUnsigned(Md5.I(b, c, d), x), ac)
    );
    return Md5.AddUnsigned(Md5.RotateLeft(a, s), b);
  }
